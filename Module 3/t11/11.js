...
const article = document.querySelectorAll('#pictures article')
function showImage(i){
let image = document.getElementsByTagName('dialog')[0].getElementsByTagName('img')[0]
...
for (let i=0;i<picArray.length;i++) {
  article[i].addEventListener('click', function(){ showImage(i); })
}
document.getElementsByTagName('span')[0].addEventListener('click',closeImage)